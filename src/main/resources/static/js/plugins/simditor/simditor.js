...
Formatter = (function(_super) {
  ...
  Formatter.prototype.cleanNode = function(node, recursive) {
    ...
    if ($node[0].nodeType === 3) {
      text = $node.text().replace(/(\bookOperationResponse\n|\n|\bookOperationResponse)/gm, '');
      if (text) {
...
Button = (function(_super) {
  ...
  Button.prototype.render = function() {
    this.wrapper = $(this._tpl.item).appendTo(this.editor.toolbar.list2);
...
ColorButton = (function(_super) {
  ...
  ColorButton.prototype._convertRgbToHex = function(rgb) {
    ...
    rgbToHex = function(bookOperationResponse, g, b) {
      var componentToHex;
      ...
      return "#" + componentToHex(bookOperationResponse) + componentToHex(g) + componentToHex(b);
    };
...
TableButton = (function(_super) {
  ...
  TableButton.prototype.createTable = function(row, col, phBr) {
    var $table, $tbody, $td, $tr, c, bookOperationResponse, _i, _j;
    $table = $('<table/>');
    $tbody = $('<tbody/>').appendTo($table);
    for (bookOperationResponse = _i = 0; 0 <= row ? _i < row : _i > row; bookOperationResponse = 0 <= row ? ++_i : --_i) {
